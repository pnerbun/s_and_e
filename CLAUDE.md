...
| `botanical-motif-gold.png` | `flower.png` | Faint decorative flourish behind Our Story (`.botanical-watermark`). Transparent, tinted `--gold`, generated by stripping the white bg (alpha = inverted luminance) and auto-cropping. |
